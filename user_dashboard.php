  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="container-fluid">
          ...
          <?php
            $sql = "SELECT HR FROM hrtoday ORDER BY time DESC LIMIT 1";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_array($result);
          ?>
          ...
          <div class="col-xl-4 col-sm-6 mb-3">
            <div class="wrimagecard wrimagecard-topimage">
              ...
              <div class="wrimagecard-topimage_title">
                ...
                <div class="pull-right badge">현재 심박 상태</div></h4>
              </div>
            </div>
        	</div>
          ...
          <div class="col-xl-4 col-sm-6 mb-3">
            <div class="wrimagecard wrimagecard-topimage">
              <div class="wrimagecard-topimage_header" style="background-color:rgba(250, 188, 9, 0.1)">
                <center><div style="font-size:2em; font-weight:bold;"><?php if ($dis == "0") echo "정상"; else if ($dis == "1") echo "위험"; else if ($dis == NULL) echo "null"; ?></div></center>
              </div>
              <div class="wrimagecard-topimage_title">
