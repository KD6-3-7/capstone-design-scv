  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">수면 모니터링</li>
      </ol>
              ...
              echo "</thead>";
        			...
        			if ($result->num_rows > 0) {
        				...
        				while($row = $result->fetch_assoc()) {
        					echo "<tr style=\"cursor: pointer;\" onClick=\"location.href='user_sleeptime.php?id=" .$row["id"]. "'\" onMouseOver=\"window.status='user_sleeptime.php?id=" .$row["id"]. "'\">";
      						echo "<td>" . $row["id"] . "</td>";
      						echo "<td>" . $row["name"] . "</td>";
